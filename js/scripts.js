$(document).ready(function () {
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        if (MD5($('#invite_code').val()) !== 'b0e53b10c1f55ede516b240036b88f40'
            ...
            $.post('https://script.google.com/macros/s/AKfycbxSZh0zzyEApGi5H8r5WVxzq9W6zgvGpPq6alY_Y-6zrpiLwv0V25GzxpXdEXQzwYCH/exec', data)
                .done(function (data) {
                    console.log(data);
...
// Google map
function initMap() {
    var location = {lat: 3.1528, lng: 101.7038};
