$(document).ready(function () {
  ...
  var myCalendar = createCalendar({
    ...
    data: {
      ...
      // Event Description
      description:
        "We can't wait to see you on our big day. For any queries or issues, please contact Ph Rashidah Ibrahim at at +60 19-375 1488.",
    },
  });
...
// Google map
function initMap() {
  var location = { lat: 3.1383, lng: 101.648 };
...
function initBBSRMap() {
  var la_fiesta = { lat: 3.1383, lng: 101.648 };
  var map = new google.maps.Map(document.getElementById("map-canvas"), {
    zoom: 15,
    center: la_fiesta,
    scrollwheel: false,
